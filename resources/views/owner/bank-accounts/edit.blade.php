<x-layout title="Edit Rekening Bank">
    <div class="pt-24 pb-12 min-h-screen">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="glass rounded-2xl p-6 sm:p-8">
                <h1 class="text-2xl font-bold mb-6">Edit Rekening Bank</h1>

                <form method="POST" action="{{ route('owner.bank-accounts.update', $bankAccount) }}" class="space-y-6">
                    @csrf
                    @method('PUT')

                    <div>
                        <label class="block text-sm font-medium text-dark-300 mb-2">Nama Bank</label>
                        <input type="text" name="nama_bank" value="{{ old('nama_bank', $bankAccount->nama_bank) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="kode_bank" value="{{ old('kode_bank', $bankAccount->kode_bank) }}" required
                            class="w-full px-4 py-3 rounded-xl bg-dark-800/50 border border-dark-700 text-white focus:outline-none focus:border-primary-500 transition-colors"
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_rekening" value="{{ old('nomor_rekening', $bankAccount->nomor_rekening) }}" required
                            class="w-full px-4 py-3 rounded-xl bg-dark-800/50 border border-dark-700 text-white focus:outline-none focus:border-primary-500 transition-colors"
                    ...
                    <div>
                        ...
                        <input type="text" name="atas_nama" value="{{ old('atas_nama', $bankAccount->atas_nama) }}" required
                            class="w-full px-4 py-3 rounded-xl bg-dark-800/50 border border-dark-700 text-white focus:outline-none focus:border-primary-500 transition-colors"
