            ...
            <div class="glass rounded-2xl p-6">
                <form method="POST" action="{{ route('admin.karyawan.store') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="peran" value="{{ old('peran') }}" placeholder="Contoh: Penopang Singa, Pemain Kendang" required class="w-full px-4 py-3 rounded-xl bg-dark-800/50 border border-dark-700 text-white focus:outline-none focus:border-primary-500 transition-colors">
